...
// ****** Constants
	 ...
	 *             (OPUS_APPLICATION_VOIP/OPUS_APPLICATION_AUDIO/OPUS_APPLICATION_RESTRICTED_LOWDELAY)<br>
	 ...
	 *              frame_size*channels*sizeof(opus_int16)<br>
	 ...
	 *          Original signature :
	 *          <code>opus_int32 opus_encode(OpusEncoder*, const opus_int16*, int, unsigned char*, opus_int32)</code><br>
	 ...
	 *          negative error code (see @ref opus_errorcodes) on failure.<br>
	 *          Original signature :
	 *          <code>opus_int32 opus_encode_float(OpusEncoder*, const float*, int, unsigned char*, opus_int32)</code><br>
	 ...
	 * opus_decoder_create,opus_decoder_get_size<br>
	 * To reset a previously initialized state, use the #OPUS_RESET_STATE CTL.<br>
	 * 
	 ...
	 *          Original signature :
	 *          <code>int opus_decode(OpusDecoder*, const unsigned char*, opus_int32, opus_int16*, int, int)</code><br>
	 ...
	 * @returns Number of decoded samples or @ref opus_errorcodes<br>
	 *          Original signature :
	 *          <code>int opus_decode_float(OpusDecoder*, const unsigned char*, opus_int32, float*, int, int)</code><br>
	 ...
	 *          Original signature :
	 *          <code>int opus_packet_parse(const unsigned char*, opus_int32, unsigned char*, const unsigned char*[48], opus_int16[48], int*)</code><br>
	 ...
	 * @retval OPUS_INVALID_PACKET The compressed data passed is corrupted or of an unsupported type<br>
	 *         Original signature :
	 *         <code>int opus_decoder_get_nb_samples(const OpusDecoder*, const unsigned char[], opus_int32)</code><br>
	 ...
	 * @param [in]     channels <tt>int</tt>: Number of channels<br>
	 * @param [in,out] softclip_mem <tt>float*</tt>: State memory for the soft clipping process (one float per channel, initialized to
	 *                 zero)<br>
	 ...
	 *         Original signature :
	 *         <code>opus_int32 opus_repacketizer_out_range(OpusRepacketizer*, int, int, unsigned char*, opus_int32)</code><br>
	 ...
	 *             failure.<br>
	 *             Original signature :
	 *             <code>OpusMSEncoder* opus_multistream_encoder_create(opus_int32, int, int, int, const unsigned char*, int, int*)</code><br>
	...
	/**
	 * Original signature :
	 * <code>OpusMSEncoder* opus_multistream_surround_encoder_create(opus_int32, int, int, int*, int*, unsigned char*, int, int*)</code><br>
	 * <i>native declaration : /tmp/opus_multistream.h:266</i>
	 */
	PointerByReference opus_multistream_surround_encoder_create(int Fs, int channels, int mapping_family, IntBuffer streams, IntBuffer coupled_streams,
			ByteBuffer mapping, int application, IntBuffer error);
	 ...
	 *          on failure.<br>
	 *          Original signature :
	 *          <code>int opus_multistream_encoder_init(OpusMSEncoder*, opus_int32, int, int, int, const unsigned char*, int)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int opus_multistream_surround_encoder_init(OpusMSEncoder*, opus_int32, int, int, int*, int*, unsigned char*, int)</code><br>
	 * <i>native declaration : /tmp/opus_multistream.h:335</i>
	 */
	int opus_multistream_surround_encoder_init(PointerByReference st, int Fs, int channels, int mapping_family, IntBuffer streams, IntBuffer coupled_streams,
			ByteBuffer mapping, int application);
	 ...
	 * <i>native declaration : /tmp/opus_multistream.h:335</i>
	 */
	int opus_multistream_surround_encoder_init(PointerByReference st, int Fs, int channels, int mapping_family, IntByReference streams, IntByReference coupled_streams,
	 ...
	 *          negative error code (see @ref opus_errorcodes) on failure.<br>
	 *          Original signature :
	 *          <code>int opus_multistream_encode(OpusMSEncoder*, const opus_int16*, int, unsigned char*, opus_int32)</code><br>
	 ...
	 *          negative error code (see @ref opus_errorcodes) on failure.<br>
	 *          Original signature :
	 *          <code>int opus_multistream_encode_float(OpusMSEncoder*, const float*, int, unsigned char*, opus_int32)</code><br>
	 ...
	 *             failure.<br>
	 *             Original signature :
	 *             <code>OpusMSDecoder* opus_multistream_decoder_create(opus_int32, int, int, int, const unsigned char*, int*)</code><br>
	 ...
	 *          on failure.<br>
	 *          Original signature :
	 *          <code>int opus_multistream_decoder_init(OpusMSDecoder*, opus_int32, int, int, int, const unsigned char*)</code><br>
	 ...
	 *          Original signature :
	 *          <code>int opus_multistream_decode(OpusMSDecoder*, const unsigned char*, opus_int32, opus_int16*, int, int)</code><br>
	 ...
	 *          (see @ref opus_errorcodes) on failure.<br>
	 *          Original signature :
	 *          <code>int opus_multistream_decode_float(OpusMSDecoder*, const unsigned char*, opus_int32, float*, int, int)</code><br>
	 ...
	 * @param [out] compressed <tt>char *</tt>: The compressed data is written here. This may not alias pcm and must be at least
	 *              maxCompressedBytes long.<br>
	 ...
	 *         Original signature :
	 *         <code>int opus_custom_encode_float(OpusCustomEncoder*, const float*, int, unsigned char*, int)</code><br>
	 ...
	 *         decoding is possible.<br>
	 *         Original signature :
	 *         <code>int opus_custom_encode(OpusCustomEncoder*, const opus_int16*, int, unsigned char*, int)</code><br>
	 ...
	 * @returns Number of decoded samples or @ref opus_errorcodes<br>
	 *          Original signature :
	 *          <code>int opus_custom_decode_float(OpusCustomDecoder*, const unsigned char*, int, float*, int)</code><br>
	 ...
	 * @returns Number of decoded samples or @ref opus_errorcodes<br>
	 *          Original signature :
	 *          <code>int opus_custom_decode(OpusCustomDecoder*, const unsigned char*, int, opus_int16*, int)</code><br>
